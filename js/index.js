...
$(function () {
        ...
        var startBox = document.getElementById("main-banner-logo");
...
$(function () {
    var zlz_txt2 = $("#zlz_txt2");
    var zlz_door= $("#door");
    var zlz_txt3 = $("#zlz_txt3");
    var botton_code_wrap = $("#botton_code_wrap");
    var zlz_img = $("#zlz_img");
    var foot_btn = $("#foot_btn");
    var zlz_em = $("#zlz_em");
    console.log(zlz_em);


    foot_btn.on('mouseenter', function () {
        zlz_em.stop().animate({
            'top':'150px'
        },500, function () {
            zlz_txt2.animate({
        ...
        botton_code_wrap.stop().animate({
            'opacity':1,
            'top':'220px'
        },500);
        zlz_door.stop().animate({
            'top':'380px',
        },500);
    });
    foot_btn.on('mouseleave', function () {
        zlz_txt2.stop().animate({
            'opacity':1
        },500);
        zlz_em.stop().animate({
            'top':'250px'
